...
const ENTER_PREZZI_GRAPH_VIEW = 'ENTER_PREZZI_GRAPH_VIEW';
const LEAVE_PREZZI_GRAPH_VIEW = 'LEAVE_PREZZI_GRAPH_VIEW';
...
const ENTER_NEWOFFER_VIEW = 'ENTER_NEWOFFER_VIEW';
const LEAVE_NEWOFFER_VIEW = 'LEAVE_NEWOFFER_VIEW';
...
export function enterPrezziGraph(time = moment().format()) {
  return {
    type:         ENTER_PREZZI_GRAPH_VIEW,
    currentView:  'PrezziGraph',
    enterTime:    time,
    leaveTime:    null
  };
}

export function leavePrezziGraph(time = moment().format()) {
  return {
    type:         LEAVE_PREZZI_GRAPH_VIEW,
    currentView:  'PrezziGraph',
    enterTime:    null,
    leaveTime:    time
  };
...
export function enterNewOffer(time = moment().format()) {
  return {
    type:         ENTER_NEWOFFER_VIEW,
    currentView:  'NewOfferView',
    enterTime:    time,
    leaveTime:    null
  };
}

export function leaveNewOffer(time = moment().format()) {
  return {
    type:         LEAVE_NEWOFFER_VIEW,
    currentView:  'NewOfferView',
    enterTime:    null,
    leaveTime:    time
  };
